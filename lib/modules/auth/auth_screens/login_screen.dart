...
import '../../forget_password/forget_password/forget_password.dart';
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                const Text('البريد الالكتروني',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                Form(
                                    key: formKey,
                                    child: Column(
                                      crossAxisAlignment:
                                      ...
                                      children: [
                                        Padding(
                                         ...
                                         const Text('كلمة المرور',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 24.0),
                                          child: customFormField(
                                ...
                                const Center(child: Text('او سجل الدخول من خلال',style: TextStyle(fontSize: 13,fontWeight: FontWeight.w500),)),
                                 SizedBox(
                                  height: 24.h,
                                ),
                                Padding(
